...
from thumbnails_graphs import thumbnails_graphs 
...
#######################################################
cmd_help_strings = {
  'thumbnails-graphs' : "Generate all graphs from the INPUT_FILES and place " \
                  + "them in OUTPUT_FOLDER. Do this acording to the " \
                  + "configuration options in CONFIG-FILE."
}
commands = [
  {
    'name'        : 'thumbnails-graphs',
    'description' : cmd_help_strings['thumbnails-graphs'],
    'arg_params'  : ['config-file'],
    'func'        : 'thumbnails_graphs',
  },
]
